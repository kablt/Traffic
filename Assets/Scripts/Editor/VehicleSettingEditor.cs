...
public class VehicleSettingEditor : Editor
{
    ...
    private static void SetupVehicle()
    {
        ...
        //현재 차를 선택했다면.(아직 세팅되지않은)
        GameObject selected = Selection.activeGameObject;
        //오리지널 프래팹과 연결이 끊겨서 내맘대로 수정이 가능합니다, 예를들어 차일드의 추가.삭제 같은거.
        ...
        //7.바디 콜라이더 붙여주고.
        BoxCollider bocCollider = EditorHelper.AddComponent<BoxCollider>(selected);
        bocCollider.isTrigger = true;
